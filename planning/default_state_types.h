...
class ControlPlanningState {
 public:
  ...
  // TODO(calderpg) Remove this as soon as CRU GraphNode<T> deserialization
  // does not require default constructibility of state types.
...
/// Defines template instantiations for drake's default planning state types.
...
template SomeType<::drake::planning::ControlPlanningState<::Eigen::Vector2d>>; \
template SomeType<::drake::planning::ControlPlanningState<::Eigen::Vector3d>>; \
template SomeType<::drake::planning::ControlPlanningState<::drake::math::RigidTransformd>>; /* NOLINT(whitespace/line_length) */ \
template SomeType<::drake::planning::ControlPlanningState<::Eigen::VectorXd>>;

/// Declares that template instantiations exist for drake's default planning
/// state types.
...
extern template SomeType<::drake::planning::ControlPlanningState<::Eigen::Vector2d>>; /* NOLINT(whitespace/line_length) */ \
extern template SomeType<::drake::planning::ControlPlanningState<::Eigen::Vector3d>>; /* NOLINT(whitespace/line_length) */ \
extern template SomeType<::drake::planning::ControlPlanningState<::drake::math::RigidTransformd>>; /* NOLINT(whitespace/line_length) */ \
extern template SomeType<::drake::planning::ControlPlanningState<::Eigen::VectorXd>>; /* NOLINT(whitespace/line_length) */

}  // namespace planning
}  // namespace drake

// Manually declare the supported instantiations of ControlPlanningState.
extern template class ::drake::planning::ControlPlanningState<::Eigen::Vector2d>;
extern template class ::drake::planning::ControlPlanningState<::Eigen::Vector3d>;
extern template class ::drake::planning::ControlPlanningState<::drake::math::RigidTransformd>; /* NOLINT(whitespace/line_length) */
extern template class ::drake::planning::ControlPlanningState<::Eigen::VectorXd>;
